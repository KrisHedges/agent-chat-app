...
```json
{
  ...
  "starterPrompts": [
    ...
    },
    {
      ...
      "prompt": "How do I customize this application? Walk me through configuring agent.config.json, modifying the UI theme and branding, and locking it down for production.",
      "icon": "settings"
    }
  ],
  "enabledSkills": [
